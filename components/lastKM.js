let data_lastKM = [
    {name:'Qiaokou', data:[187, 62, 470, 59]},
    {name:'Wuchang', data:[357, 84, 1046, 523]},
    {name:'Dongxihu', data:[150, 94, 386, 257]},
    {name:'Jiangan', data:[250, 146, 956, 510]},
    {name:'Hannan', data:[63, 11, 52, 0]},
    {name:'Jianghan', data:[241, 131, 594, 416]},
    {name:'Caidian', data:[121, 81, 318, 159]},
    {name:'Hanyang', data:[127, 36, 374, 0]},
    {name:'Jiangxia', data:[205, 160, 420, 0]},
    {name:'Huangpi', data:[119, 60, 288, 57]},
    {name:'Xinzhou', data:[63, 21, 138, 69]},
    {name:'Qingshan', data:[124, 64, 196, 0]},
    {name:'Hongshan', data:[365, 264, 1142, 605]},
]
...
$(document).ready(function () {
    ...
    function drawChart() {
        ...
        lastKMChart.append('text')
            ...
            .attr('fill', 'white')
            .attr('transform', `rotate(-45 ${-70 + 12},${0})`)
            .text('District')
    ...
    registerScroll('#lastKMSvg', (event, isDown) => {
        if (stage_ll === 0 && isDown > 0) {
            ...
            if(isDown){
                if(!pushDot()) {
                    showGuideS(true, (e)=>e&&scrollTo(4), 940)
                }
            } else {
                if(!pullDot()) {
                    showGuideS(false, (e)=>!e&&scrollTo(2))
                }
            }
        }
    }, 50)
    progressLoaded('Unity Component')
})
